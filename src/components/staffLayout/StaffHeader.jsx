...
import { STAFF_NAV_ITEMS } from "./staffNavConfig";
    ...
    <header className="sticky top-0 z-30 bg-white/90 backdrop-blur border-b border-ink-100 relative">
      ...
      <div className="flex items-center justify-between h-16 px-4 sm:px-6">
        ...
        <div className="lg:hidden flex items-center gap-2">
          ...
          <span className="font-display font-semibold text-sm text-gradient-brand">Staff Portal</span>
        </div>
        ...
        <div className="flex items-center gap-3">
          <div className="hidden sm:flex flex-col items-end leading-tight">
            ...
            <span className="text-[11px] text-ink-400">{user?.staffId}</span>
          </div>
        ...
        <div className="fixed inset-0 z-50 lg:hidden">
          ...
          <div className="absolute left-0 top-0 bottom-0 w-72 bg-gradient-ink text-paper flex flex-col animate-fade-up">
            <div className="flex items-center justify-between px-5 h-16 border-b border-white/10">
              <span className="font-display font-semibold text-sm">Staff Portal</span>
